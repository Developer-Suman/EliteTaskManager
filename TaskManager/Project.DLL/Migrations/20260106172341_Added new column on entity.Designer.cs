...
namespace Project.DLL.Migrations
{
    ...
    [Migration("20260106172341_Added new column on entity")]
    partial class Addednewcolumnonentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.DLL.Models.ControllerAction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.Menu", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.Modules", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.RoleModule", b =>
                {
                    b.Property<string>("RoleId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.SubModules", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.Task.SetUp.NickName", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.Task.SetUp.ProjectDetails", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.Task.TaskDetails", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project.DLL.Models.UserControllerAction", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "ControllerActionId");

                    b.ToTable("UserControllerActions");
                });
            ...
            modelBuilder.Entity("Project.DLL.Models.Menu", b =>
                {
                    b.HasOne("Project.DLL.Models.SubModules", "SubModules")
                        .WithMany("Menu")
            ...
            modelBuilder.Entity("Project.DLL.Models.RoleModule", b =>
                {
                    b.HasOne("Project.DLL.Models.Modules", "Modules")
            ...
            modelBuilder.Entity("Project.DLL.Models.Task.TaskDetails", b =>
                {
                    b.HasOne("Project.DLL.Models.Task.SetUp.NickName", "NickName")
                        .WithMany("TaskDetails")
                        .HasForeignKey("NickNameId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Project.DLL.Models.Task.SetUp.ProjectDetails", "ProjectDetails")
                        .WithMany("TaskDetails")
            ...
            modelBuilder.Entity("Project.DLL.Models.UserControllerAction", b =>
                {
                    b.HasOne("Project.DLL.Models.ApplicationUsers", "User")
                        .WithMany("userControllerActions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project.DLL.Models.ControllerAction", "ControllerActions")
                        .WithMany("userControllerActions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Project.DLL.Models.ApplicationUsers", b =>
                {
                    ...
                    b.Navigation("userControllerActions");
                });
