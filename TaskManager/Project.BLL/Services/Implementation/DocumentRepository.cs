...
namespace Project.BLL.Services.Implementation
{
    public class DocumentRepository : IDocumentsRepository
    {
        ...
        public async Task<Result<List<DocumentsGetDTOs>>> GetAll(PaginationDTOs paginationDTOs, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var documentPagedResult = await documentsData.ToPagedResultAsync(paginationDTOs.pageIndex, paginationDTOs.pageSize, paginationDTOs.IsPagination);
