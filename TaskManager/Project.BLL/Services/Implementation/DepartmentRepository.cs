...
namespace Project.BLL.Services.Implementation
{
    public class DepartmentRepository : IDepartmentRepository
    {
        ...
        public async Task<Result<PagedResult<DepartmentGetDTOs>>> GetAll(PaginationDTOs paginationDTOs, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var departmentPagedResult = await departmentData.AsNoTracking().ToPagedResultAsync(paginationDTOs.pageIndex, paginationDTOs.pageSize, paginationDTOs.IsPagination);
