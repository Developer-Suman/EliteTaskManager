    ...
    public class BranchRepository : IBranchRepository
    {
        ...
        public async Task<Result<BranchGetDTOs>> DeleteBranch(string BranchId, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (branch is null)
                {
                    return Result<BranchGetDTOs>.Failure("NotFounds", "Branch cannot be Found");
        ...
        public async Task<Result<PagedResult<BranchGetDTOs>>> GetAll(PaginationDTOs paginationDTOs, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var branchPagedResult = await branchData.AsNoTracking().ToPagedResultAsync(paginationDTOs.pageIndex, paginationDTOs.pageSize, paginationDTOs.IsPagination);
